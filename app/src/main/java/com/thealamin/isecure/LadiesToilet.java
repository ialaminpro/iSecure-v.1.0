...
public class LadiesToilet extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener, OnMapReadyCallback {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.Emergency_service) {
            ...
            Intent refresh = new Intent(this,DangerZone.class);
            startActivity(refresh);
            finish();

        } else if (id == R.id.Police_Station) {
            Intent refresh = new Intent(this,PoliceStation.class);
            startActivity(refresh);
            finish();

        } else if (id == R.id.Hospital_view) {
            Intent refresh = new Intent(this,HospitalView.class);
            startActivity(refresh);
            finish();
            ...
            Intent refresh = new Intent(this,CourtView.class);
            startActivity(refresh);
            finish();

        } else if (id == R.id.App_User) {

            Intent refresh = new Intent(this,AppUser.class);
            startActivity(refresh);
            finish();
