...
public class EmergencyNumber extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public void saveLangupreference(int i){
        ...
        if(i==1){
            ...
            Intent refresh = new Intent(this,EmergencyNumber.class);
            startActivity(refresh);
            finish();
